...
contract MintScript is Script {
    uint256 constant SLIPPAGE_PERCENTAGE = 2; // 2%
    ...
    uint256 amountRequired = 1000000000000000000; // 1 HYPE in wei
    ...
    uint256 paymentValue = (amountRequired * (HUNDRED + SLIPPAGE_PERCENTAGE)) / HUNDRED;

    // Mint with HYPE + referral
    minterContract.mintWithNative{value: paymentValue}(label, durationInYears, sig, timestamp, referral_hash);
